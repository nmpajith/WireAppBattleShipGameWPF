...
{
    public class OccupationStatusToColorConverterAutoPlayer : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return occupationStatus switch
            {
                ...
                OccupationStatus.Battleship => new SolidColorBrush(Color.FromArgb(255, 51, 153, 255)),
                OccupationStatus.Destroyer => new SolidColorBrush(Color.FromArgb(255, 51, 153, 255)),
